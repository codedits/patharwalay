        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <details className="md:block">
              <summary className="list-none flex items-center justify-between md:block cursor-pointer select-none">
                <span className="text-sm font-semibold">About us</span>
                <span className="md:hidden ml-2 text-muted transition-transform">▾</span>
              </summary>
              <div className="mt-2 text-sm text-muted">We curate ethically sourced gemstones and craft them into timeless jewelry with modern sensibility.</div>
            </details>
          </div>
...
>>>>>>> b178fd23293d1c384b7a37d0b007e0e6db7b79cf
              </div>
            </details>
          </div>
        </div>
